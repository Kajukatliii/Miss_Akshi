...
buttons = [
        ...
        InlineKeyboardButton(
            text="𝘈𝘥𝘥 𝘮𝘦 𝘯𝘰𝘸➕", url="t.me/Miss_Akshi2_0_bot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="𝘔𝘪𝘴𝘴 𝘈𝘬𝘴𝘩𝘪 𝘭𝘰𝘨𝘴❤️", url=f"https://t.me/Miss_Akshi_Log"),
    ],
    [
        InlineKeyboardButton(
            text="𝘜𝘱𝘥𝘢𝘵𝘦𝘴🤞", url=f"https://t.me/Miss_Akshi_updates"
        ),
        InlineKeyboardButton(
            text="𝘚𝘶𝘱𝘱𝘰𝘳𝘵😍", url=f"https://t.me/Miss_Akshi_Support"
        ),
    ],
    [
        InlineKeyboardButton(text="𝘏𝘦𝘭𝘱 𝘢𝘯𝘥 𝘊𝘮𝘥𝘴❓", url="http://t.me/Miss_Akshi2_0_bot?start=help"
        ),
    ],
]
